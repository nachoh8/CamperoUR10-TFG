...
if __name__ == '__main__':
	...
	tf_listener.waitForTransform('campero_map','aruco_tf',rospy.Time(), rospy.Duration(0.8))#0.1		#Cambiar aqui y abajo los frames
	rate = rospy.Rate(24)

	while not rospy.is_shutdown():
		try:		
			(trans,rot)=tf_listener.lookupTransform('campero_map','aruco_tf',rospy.Time(0))	#Cambiar frames
